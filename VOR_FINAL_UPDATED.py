...
"""
    ...
    def show_exit_confirmation(self):
        ...
        self.confirm_exit_window.geometry("340x140")
        ...
        # Optionally add a close button for mouse users
        close_btn = tk.Button(self.confirm_exit_window, text="Cancel", command=self.cancel_exit)
    ...
    def poll_confirm_exit_controller(self):
        ...
        try:
            ...
            pygame.event.pump()
            if self.joystick:
                # Y button (update this index if needed)
                if self.joystick.get_button(4):  # 4 is usually Y on Xbox-style
                    self.confirm_exit()
                    return
        except Exception:
            pass
